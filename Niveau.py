    ...
    def __init__(self,niveau,difficulte,mode_affichage,mode_minimap,destination=None,debut_niveau=False,joueur=None,labyrinthe=None,entitees=None,evenements=None,horloge_cycle=None):
        ...
        if labyrinthe == None:
            if niveau == 0:
                ...
                self.pieges = [[(15,31),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(2,36),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(2,35),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(2,31),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(3,33),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(3,32),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(4,36),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(4,33),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(4,31),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(5,34),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(6,35),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(6,32),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(7,33),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(7,32),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(8,5),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(8,9),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(9,5),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(9,7),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(9,9),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(10,7),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(10,9),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(11,4),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(11,5),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(11,6),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(11,7),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(11,9),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(12,9),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(13,5),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(13,6),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(13,7),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(13,8),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))],[(13,9),Piques(self.LARGEUR_CASE,self.LARGEUR_MUR,10,True,(0,0,0))]]
                self.fontaines = [[(21,23),Fontaine_heal(self.LARGEUR_CASE,self.LARGEUR_MUR,0,False,(20,20,125))]]
                self.cases_speciales = self.teleporteurs_officiels + self.teleporteurs_officieux + self.pieges + self.fontaines
