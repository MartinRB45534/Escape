...
class Joueur:
    ...
    def dessine_toi(self,screen,decalage,position_screen):
        pygame.draw.rect(screen, pygame.Color(0,255,0),((decalage[0])*(LARGEUR_CASE+LARGEUR_MUR)+2+position_screen[0],(decalage[1])*(LARGEUR_CASE+LARGEUR_MUR)+2+position_screen[1],LARGEUR_CASE-2*LARGEUR_MUR,LARGEUR_CASE-2*LARGEUR_MUR))
